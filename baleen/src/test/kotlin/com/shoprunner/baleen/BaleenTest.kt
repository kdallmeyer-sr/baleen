    ...
    inner class NestedDesc {
        ...
        fun `validates when present`() {
            ...
            assertThat(packWithAlpha.validate(packData).results)
                    ...
                    .contains(ValidationInfo(dataTrace("at attribute \"alpha\""), "has attribute \"name\"", dogData))
        ...
        fun `child not the right type`() {
            ...
            assertThat(packWithAlpha.validate(data).results)
                    ...
                    .contains(ValidationError(dataTrace("at attribute \"alpha\""), "expected to be of type Data but is class java.lang.String", "Fido"))
